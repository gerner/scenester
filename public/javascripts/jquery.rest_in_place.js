...
RestInPlaceEditor.forms = {
  "input" : {
    ...
    activateForm : function() {
      this.element.html('<form action="javascript:void(0)" style="display:inline;"><input type="text" value=""></form>');
      jQuery(this.element.find('input')[0]).prop("value", jQuery.trim(this.oldValue));
